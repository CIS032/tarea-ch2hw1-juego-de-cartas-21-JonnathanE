 ...
 * baraja de póquer estándar, incluidos los comodines. La tarjeta tiene un traje, que
 * puede ser espadas, corazones, diamantes, palos o bromista. Una pala, corazón,
 * diamante o palo tiene uno de los 13 valores: as, 2, 3, 4, 5, 6, 7,
 * 8, 9, 10, jota, reina o rey. Tenga en cuenta que "as" se considera que es
...
public class Card {
    ...
    public final static int ACE = 1;      // Códigos para las cartas no numéricas.
    public final static int JACK = 11;    //   Las cartas 2 a 10 tienen su
    ...
    /**
     * El valor de la carta. Para una carta normal, este es uno de los valores
